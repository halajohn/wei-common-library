...
extern "C"
{
  WCL_COLORLIB_SRGB_PLUGIN_EXPORT Wcl::Colorlib::ColorSpaceConverterPlugin *
  create_plugin(Wcl::Colorlib::ColorSpaceConverter * const converter)
  {
    return ::new Wcl::Colorlib::ColorSpaceConverterPluginSrgb(converter);
  }
  
  WCL_COLORLIB_SRGB_PLUGIN_EXPORT void
  delete_plugin(Wcl::Colorlib::ColorSpaceConverterPlugin * const plugin)
  {
    ::delete(plugin);
  }
  
  WCL_COLORLIB_SRGB_PLUGIN_EXPORT wchar_t const *
  name()
  {
    return L"sRGB";
  }
...
namespace Wcl
{
  namespace Colorlib
  {
    ColorSpaceConverterPluginSrgb::ColorSpaceConverterPluginSrgb(
    ...
    void
    ColorSpaceConverterPluginSrgb::get_chromaticity_data(
      double &xr, double &yr,
      double &xg, double &yg,
      double &xb, double &yb,
    ...
    wchar_t const *
    ColorSpaceConverterPluginSrgb::get_rgb_plugin_name() const
    {
      return ::name();
    }
    
    void
    ColorSpaceConverterPluginSrgb::get_rgb_plugin_parent_name_list(
      wchar_t const ***parent_name_list,
