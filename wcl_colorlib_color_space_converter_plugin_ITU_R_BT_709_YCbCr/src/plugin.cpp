...
extern "C"
{
  WCL_COLORLIB_ITU_R_BT_709_YCBCR_PLUGIN_EXPORT Wcl::Colorlib::ColorSpaceConverterPlugin *
  create_plugin(Wcl::Colorlib::ColorSpaceConverter * const converter)
  {
    return ::new Wcl::Colorlib::ColorSpaceConverterPluginItuRBt709YCbCr(converter);
  }

  WCL_COLORLIB_ITU_R_BT_709_YCBCR_PLUGIN_EXPORT void
  delete_plugin(Wcl::Colorlib::ColorSpaceConverterPlugin * const plugin)
  {
    ::delete(plugin);
  }
  
  WCL_COLORLIB_ITU_R_BT_709_YCBCR_PLUGIN_EXPORT wchar_t const *
  name()
  {
    ...
    Wcl::uint32_t *parent_name_list_size)
  {
    ...
    static wchar_t const *parent_name_list_data[1] = {L"YCbCr"};
...
namespace Wcl
{
  ...
  {    
    wchar_t const *
    ColorSpaceConverterPluginItuRBt709YCbCr::get_ycbcr_plugin_name() const
    {
      return ::name();
    }
    
    void
    ColorSpaceConverterPluginItuRBt709YCbCr::get_ycbcr_plugin_parent_name_list(
      wchar_t const ***parent_name_list,
