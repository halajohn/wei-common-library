...
extern "C"
{
  WCL_COLORLIB_CUSTOM_YPBPR_PLUGIN_EXPORT Wcl::Colorlib::ColorSpaceConverterPlugin *
  create_plugin(Wcl::Colorlib::ColorSpaceConverter * const converter)
  {
    return ::new Wcl::Colorlib::ColorSpaceConverterPluginCustomYPbPr(converter);
  }

  WCL_COLORLIB_CUSTOM_YPBPR_PLUGIN_EXPORT void
  delete_plugin(Wcl::Colorlib::ColorSpaceConverterPlugin * const plugin)
  {
    ::delete(plugin);
  }
  
  WCL_COLORLIB_CUSTOM_YPBPR_PLUGIN_EXPORT wchar_t const *
  name()
  {
    return L"YPbPr";
  }
...
namespace Wcl
{
  ...
  {
    wchar_t const *
    ColorSpaceConverterPluginCustomYPbPr::get_ypbpr_plugin_name() const
    {
      return ::name();
    }
    
    void
    ColorSpaceConverterPluginCustomYPbPr::get_ypbpr_plugin_parent_name_list(
      wchar_t const ***parent_name_list,
