...
#if defined(WCL_COLORLIB_SUBSAMPLING_CONVERTER_PLUGIN_MPEG2_YUV420_EXPORTS)
...
namespace Wcl
{
  namespace Colorlib
  {
    class SubSamplingConverterPluginMpeg2Yuv420 : public SubSamplingConverterPlugin
    {
    private:
      
      virtual void get_ycbcr_color_space_name(std::list<std::wstring> &names);
      
      SubSamplingConverterPluginMpeg2Yuv420 &operator=(SubSamplingConverterPluginMpeg2Yuv420 const &plugin);
    ...
    typedef class SubSamplingConverterPluginMpeg2Yuv420 SubSamplingConverterPluginMpeg2Yuv420;
  }
}
