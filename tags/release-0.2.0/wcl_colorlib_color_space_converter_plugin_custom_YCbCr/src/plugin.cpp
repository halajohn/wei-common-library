...
extern "C"
{
  WCL_COLORLIB_CUSTOM_YCBCR_PLUGIN_EXPORT Wcl::Colorlib::ColorSpaceConverterPlugin *
  create_plugin(Wcl::Colorlib::ColorSpaceConverter * const converter)
  {
    return ::new Wcl::Colorlib::ColorSpaceConverterPluginCustomYCbCr(converter);
  }

  WCL_COLORLIB_CUSTOM_YCBCR_PLUGIN_EXPORT void
  delete_plugin(Wcl::Colorlib::ColorSpaceConverterPlugin * const plugin)
  {
    ::delete(plugin);
  }
  
  WCL_COLORLIB_CUSTOM_YCBCR_PLUGIN_EXPORT wchar_t const *
  name()
  {
    return L"YCbCr";
  }
...
namespace Wcl
{
  ...
  {    
    wchar_t const *
    ColorSpaceConverterPluginCustomYCbCr::get_ycbcr_plugin_name() const
    {
      return ::name();
    }
    
    void
    ColorSpaceConverterPluginCustomYCbCr::get_ycbcr_plugin_parent_name_list(
      wchar_t const ***parent_name_list,
