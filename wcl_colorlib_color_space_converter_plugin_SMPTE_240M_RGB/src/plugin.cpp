...
extern "C"
{
  WCL_COLORLIB_SMPTE_240M_RGB_PLUGIN_EXPORT Wcl::Colorlib::ColorSpaceConverterPlugin *
  create_plugin(Wcl::Colorlib::ColorSpaceConverter * const converter)
  {
    return ::new Wcl::Colorlib::ColorSpaceConverterPluginSmpte240mRgb(converter);
  }

  WCL_COLORLIB_SMPTE_240M_RGB_PLUGIN_EXPORT void
  delete_plugin(Wcl::Colorlib::ColorSpaceConverterPlugin * const plugin)
  {
    ::delete(plugin);
  }
  
  WCL_COLORLIB_SMPTE_240M_RGB_PLUGIN_EXPORT wchar_t const *
  name()
  {
    return L"SMPTE 240M";
  }
...
namespace Wcl
{
  namespace Colorlib
  {
    ColorSpaceConverterPluginSmpte240mRgb::ColorSpaceConverterPluginSmpte240mRgb(ColorSpaceConverter * const converter)
    ...
    void
    ColorSpaceConverterPluginSmpte240mRgb::get_chromaticity_data(
      double &xr, double &yr,
      double &xg, double &yg,
      double &xb, double &yb,
    ...
    wchar_t const *
    ColorSpaceConverterPluginSmpte240mRgb::get_rgb_plugin_name() const
    {
      return ::name();
    }
    
    void
    ColorSpaceConverterPluginSmpte240mRgb::get_rgb_plugin_parent_name_list(
      wchar_t const ***parent_name_list,
